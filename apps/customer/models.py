...
class CustomerInfo(models.Model):
    ...
    company_ABN = models.CharField(max_length=255, null=True, blank=True, unique=True)
    ...
    type = models.CharField(max_length=50, choices=CUSTOMER_TYPE, default='New Lead')
